...
| `docs/` | `MP1_report.md` / `MP1_report.pdf` (design choices + period analysis; `build_pdf.py` regenerates the PDF with lualatex), `MP1_BOM.csv`, `MP1_schematic.pdf`, the assignment PDF and the allowed parts list. |
